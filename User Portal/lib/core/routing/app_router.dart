...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      // Standalone route for unauthenticated login screen
      GoRoute(
      ...
      ShellRoute(
        builder: (context, state, child) {
          // Pass current path to keep track of active sidebar pill state
          final path = state.uri.path;
          return MainLayout(currentPath: path, child: child);
        },
        routes: [
          GoRoute(

...
const ProductModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'lowStockAlertLevel': PropertySchema(
      id: 6,
      name: r'lowStockAlertLevel',
      type: IsarType.long,
    ),
...
void _productModelSerialize(
  ...
  writer.writeLong(offsets[3], object.currentStock);
  writer.writeString(offsets[4], object.id);
  writer.writeString(offsets[5], object.imageUrl);
  writer.writeLong(offsets[6], object.lowStockAlertLevel);
...
ProductModel _productModelDeserialize(
  ...
  object.currentStock = reader.readLong(offsets[3]);
  object.id = reader.readString(offsets[4]);
  object.imageUrl = reader.readStringOrNull(offsets[5]);
  object.localId = id;
  object.lowStockAlertLevel = reader.readLong(offsets[6]);
  object.name = reader.readString(offsets[7]);
  object.sellingPrice = reader.readDouble(offsets[8]);
  object.sku = reader.readString(offsets[9]);
  return object;
}
...
extension ProductModelByIndex on IsarCollection<ProductModel> {
  ...
  ProductModel? getBySkuSync(String sku) {
  ...
  Future<List<ProductModel?>> getAllBySku(List<String> skuValues) {
    final values = skuValues.map((e) => [e]).toList();
    return getAllByIndex(r'sku', values);
  }

  List<ProductModel?> getAllBySkuSync(List<String> skuValues) {
    final values = skuValues.map((e) => [e]).toList();
  ...
  Future<Id> putBySku(ProductModel object) {
    return putByIndex(r'sku', object);
  }

  Id putBySkuSync(ProductModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'sku', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllBySku(List<ProductModel> objects) {
    return putAllByIndex(r'sku', objects);
  }

  List<Id> putAllBySkuSync(List<ProductModel> objects,
      {bool saveLinks = true}) {
...
extension ProductModelQueryWhere
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhereClause> skuEqualTo(
      String sku) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'sku',
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterWhereClause> skuNotEqualTo(
      String sku) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ProductModelQueryFilter
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterFilterCondition>
      lowStockAlertLevelEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lowStockAlertLevel',
        value: value,
      ));
    });
  }
...
extension ProductModelQuerySortBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> sortByCurrentStock() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy>
      sortByLowStockAlertLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lowStockAlertLevel', Sort.asc);
    });
  }

  QueryBuilder<ProductModel, ProductModel, QAfterSortBy>
      sortByLowStockAlertLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lowStockAlertLevel', Sort.desc);
    });
  }
...
extension ProductModelQuerySortThenBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenByCurrentStock() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentStock', Sort.asc);
    });
  }
...
extension ProductModelQueryWhereDistinct
  ...
  QueryBuilder<ProductModel, ProductModel, QDistinct> distinctByCurrentStock() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QDistinct>
      distinctByLowStockAlertLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lowStockAlertLevel');
    });
  }
...
extension ProductModelQueryProperty
  ...
  QueryBuilder<ProductModel, int, QQueryOperations> currentStockProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, int, QQueryOperations>
      lowStockAlertLevelProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lowStockAlertLevel');
    });
  }
